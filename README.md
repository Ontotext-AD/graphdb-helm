...
| security.sso.clientIdKey | string | `""` |  |
| security.sso.clientSecretKey | string | `""` |  |
| security.sso.enabled | bool | `false` |  |
| security.sso.existingSecret | string | `""` |  |
| security.sso.tokenUrlKey | string | `""` |  |
| security.sso.scopesKey | string | `""` |  |
