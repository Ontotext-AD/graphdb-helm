...
| cluster.config.tls.certificate.certificateKey | string | `""` |  |
...
| cluster.config.tls.keystore.keystoreProvider | string | `""` |  |
| cluster.config.tls.keystore.keystoreType | string | `""` |  |
...
| cluster.config.tls.rootCerts.rootCertsKey | string | `""` |  |
| cluster.config.tls.rootCerts.secretName | string | `""` |  |
...
| cluster.config.tls.truststore.truststoreProvider | string | `""` |  |
| cluster.config.tls.truststore.truststoreType | string | `""` |  |
