...
See more about the cluster here: https://graphdb.ontotext.com/documentation/11.5/cluster-basics.html
...
See https://graphdb.ontotext.com/documentation/11.5/access-control.html
...
See https://graphdb.ontotext.com/documentation/11.5/directories-and-config-properties.html#configuration-properties
...
| command | list | `[]` |  |
| configuration.defaultJavaArguments | string | `"-XX:MaxRAMPercentage=70"` |  |
...
| podAntiAffinity.avoidProxies | bool | `false` |  |
...
| proxy.podAntiAffinity.avoidCluster | bool | `false` |  |
...
| proxy.service.trafficDistribution | string | `""` |  |
...
| proxy.topologySpreadConstraintsPreset.minDomains | string | `nil` |  |
...
| security.admin.initialPasswordHash | string | `""` |  |
...
| security.oauth2.clientIdKey | string | `""` |  |
| security.oauth2.clientSecretKey | string | `""` |  |
| security.oauth2.enabled | bool | `false` |  |
| security.oauth2.existingSecret | string | `""` |  |
| security.oauth2.scopesKey | string | `""` |  |
| security.oauth2.tokenUrlKey | string | `""` |  |
| security.overrideUsers | bool | `false` |  |
| security.provisioner.existingSecret | string | `""` |  |
| security.provisioner.initialPasswordHash | string | `""` |  |
...
| topologySpreadConstraintsPreset.minDomains | string | `nil` |  |
