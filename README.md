...
![Version: 12.4.0](https://img.shields.io/badge/Version-12.4.0-informational?style=flat-square)
![AppVersion: 11.4.0](https://img.shields.io/badge/AppVersion-11.4.0-informational?style=flat-square)
...
See more about the cluster here: https://graphdb.ontotext.com/documentation/11.4/cluster-basics.html
...
See https://graphdb.ontotext.com/documentation/11.4/access-control.html
...
See https://graphdb.ontotext.com/documentation/11.4/directories-and-config-properties.html#configuration-properties
...
| configuration.encryption.alias | string | `"graphdb-master-key"` |  |
| configuration.encryption.file | string | `""` |  |
| configuration.encryption.keystorePasswordExistingSecret | string | `""` |  |
| configuration.encryption.keystorePasswordSecretKey | string | `"keystorePassword"` |  |
| configuration.encryption.masterKeyExistingSecret | string | `"graphdb-masterkey"` |  |
| configuration.encryption.masterKeySecretKey | string | `"masterKey"` |  |
| configuration.encryption.type | string | `""` |  |
...
| gatewayApi.gateway.annotations | object | `{}` |  |
| gatewayApi.gateway.className | string | `""` |  |
| gatewayApi.gateway.extraListeners | list | `[]` |  |
| gatewayApi.gateway.infrastructure.annotations | object | `{}` |  |
| gatewayApi.gateway.infrastructure.labels | object | `{}` |  |
| gatewayApi.gateway.infrastructure.parametersRef | object | `{}` |  |
| gatewayApi.gateway.labels | object | `{}` |  |
| gatewayApi.gateway.listeners.grpc.enabled | bool | `false` |  |
| gatewayApi.gateway.listeners.grpc.port | int | `7300` |  |
| gatewayApi.gateway.listeners.grpc.tls.certificateRefs | list | `[]` |  |
| gatewayApi.gateway.listeners.grpc.tls.enabled | bool | `false` |  |
| gatewayApi.gateway.listeners.grpc.tls.mode | string | `"Terminate"` |  |
| gatewayApi.gateway.listeners.http.enabled | bool | `true` |  |
| gatewayApi.gateway.listeners.http.port | int | `80` |  |
| gatewayApi.gateway.listeners.https.enabled | bool | `false` |  |
| gatewayApi.gateway.listeners.https.port | int | `443` |  |
| gatewayApi.gateway.listeners.https.tls.certificateRefs | list | `[]` |  |
| gatewayApi.gateway.listeners.https.tls.mode | string | `"Terminate"` |  |
| gatewayApi.gateway.listeners.https.tls.referenceGrant.enabled | bool | `false` |  |
| gatewayApi.gateway.listeners.https.tls.referenceGrant.secretNamespace | string | `""` |  |
| gatewayApi.gateway.listeners.tls.enabled | bool | `false` |  |
| gatewayApi.gateway.listeners.tls.port | int | `8443` |  |
| gatewayApi.grpcRoute.annotations | object | `{}` |  |
| gatewayApi.grpcRoute.enabled | bool | `false` |  |
| gatewayApi.grpcRoute.hostnames | list | `[]` |  |
| gatewayApi.grpcRoute.labels | object | `{}` |  |
| gatewayApi.httpRoute.annotations | object | `{}` |  |
| gatewayApi.httpRoute.enabled | bool | `true` |  |
| gatewayApi.httpRoute.extraHostnames | list | `[]` |  |
| gatewayApi.httpRoute.extraRules | list | `[]` |  |
| gatewayApi.httpRoute.host | string | `""` |  |
| gatewayApi.httpRoute.httpsRedirect | bool | `false` |  |
| gatewayApi.httpRoute.labels | object | `{}` |  |
| gatewayApi.httpRoute.path | string | `""` |  |
| gatewayApi.targetGroupConfiguration.annotations | object | `{}` |  |
| gatewayApi.targetGroupConfiguration.defaultConfiguration | object | `{}` |  |
| gatewayApi.targetGroupConfiguration.enabled | bool | `false` |  |
| gatewayApi.targetGroupConfiguration.labels | object | `{}` |  |
| gatewayApi.tlsRoute.annotations | object | `{}` |  |
| gatewayApi.tlsRoute.enabled | bool | `false` |  |
| gatewayApi.tlsRoute.hostnames | list | `[]` |  |
| gatewayApi.tlsRoute.labels | object | `{}` |  |
