{
  "users": {
    "admin": {
      "username": "admin",
      "password": {{ (include "graphdb.security.admin.passwordHash" .) | default "{bcrypt}$2a$10$H7uekkF1ZFLIV5M1g9tDs.syZGtkMqrfj2Si2SHG1WgwhpNqpZwne" | quote }},
    ...
    "{{ .Values.security.provisioner.username }}": {
      ...
      "password": {{ include "graphdb.security.provisioner.passwordHash" . | quote }},
      "grantedAuthorities": [ "ROLE_ADMIN" ],
      "appSettings": {
        "DEFAULT_INFERENCE": true,
        "DEFAULT_VIS_GRAPH_SCHEMA": true,
